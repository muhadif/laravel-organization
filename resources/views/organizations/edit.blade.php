    ...
    <form action="{{ route('organizations.update',$organization->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Phone:</strong>
                    <input type="text" name="phone" class="form-control" placeholder="Phone" value="{{$organization->phone}}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    @if(!empty($organization->picture))
                        <br>
                        <img width="20%" src="{{asset('storage/organization/'.$organization->picture->url )}}">
                    @endif
